...
binaries = ['gender', 'diabetesMed', 'other_meds']
categoricals = ['gender', 'race', 'A1Cresult', 'diag_1', 'diag_2', 'diag_3', 'metformin', 'insulin', 'change', 'diabetesMed', 'other_meds']
le = LabelEncoder()
